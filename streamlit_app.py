...
options = st.sidebar.selectbox("Choose an option", ["Aggregate Transaction", "Aggregate Users", "Map Transaction", "Map Users", "Top Transaction by District", "Top Transaction by Pincode", "Top Users by District", "Top Users by Pincode"])
...
if options == "Aggregate Transaction":
    ...
    with col2:
        ...
        st.subheader(AddUnit.unit(df1['Total Payment Value'][0]))
    ...
    with col2:
        ...
        with tab1:
            query2="""select state,sum(registered_users) as 'Registered Users',sum(app_opens) as 'App Opens'
